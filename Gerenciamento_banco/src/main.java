...
//fazer um arquivo que contenha as funÃ§Ãµes de inserir, remover, transferencias e buscar.
...
public class main {
    public static void main(String[] args){
        ...
        System.out.println("Para aplicar na poupança basta escrever: 'p_inserir;id;money'");
        System.out.println("Para resgatar da poupança basta escrever: 'p_resgatar;id;money'");
